...
<head>
    ...
    <style>
    /* Mesmo CSS do 404, com ajuste de cores para erro (vermelho) */
    :root {
        --accent: #ef4444;
...
<body>
    ...
    <div class="page-wrap">
        <div class="fade-in error-code">500</div>
        <div class="fade-in error-badge"><i class="fas fa-exclamation-triangle"></i> Erro Interno</div>
        <h1 class="fade-in error-title">Erro Interno do <span>Servidor</span></h1>
        <p class="fade-in error-desc">
            Algo correu mal do nosso lado. A equipa técnica foi notificada e está a trabalhar para resolver o problema.
        </p>
