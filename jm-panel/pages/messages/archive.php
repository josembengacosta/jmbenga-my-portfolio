<?php
// ══════════════════════════════════════════════════════════════
// JMbenga Portfolio — Arquivar / Desarquivar mensagem
// ══════════════════════════════════════════════════════════════
...
logAudit((int)$_SESSION['admin_id'], null, 'message.archive', '_contact_message', $id, ['status' => $currentStatus], ['status' => $newStatus]);
