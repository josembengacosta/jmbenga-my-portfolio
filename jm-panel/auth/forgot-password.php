<?php
// ══════════════════════════════════════════════════════════════
// JMbenga Portfolio — Esqueceu a Senha
// ══════════════════════════════════════════════════════════════
...
// Sistema de feedback (mesmo padrão do login)
...
$feedback = match ($msg_type) {
    'sent'      => [
        ...
        'text'    => 'Se o email existir na nossa base de dados, receberá um link de recuperação em instantes.'
    ],
    'error'     => [
        'type'    => 'danger',
        'icon'    => 'fa-exclamation-triangle',
        'text'    => $error ?: 'Ocorreu um erro ao processar o pedido. Tente novamente.'
    ],
    'invalid'   => [
        'type'    => 'danger',
...
<head>
    ...
    <title>Recuperar Senha — Painel JMbenga</title>
        ...
        <div class="recovery-card">
            ...
            <div class="recovery-left">
                <div class="left-content">
                    ...
                    <h1 class="welcome-title">Recuperar Acesso</h1>
                    <p class="welcome-desc">
                        Introduza o seu email de administrador. Se a conta existir, receberá um link para redefinir a
                        senha.
                    </p>
                    <ul class="features">
                        <li><i class="fas fa-check"></i> Email seguro</li>
                        <li><i class="fas fa-check"></i> Link expira em 1 hora</li>
                        <li><i class="fas fa-check"></i> Verifique também o spam</li>
                    </ul>
            ...
            <div class="recovery-right">
                <div class="form-header">
                    ...
                    <p class="form-subtitle">Sem stress — nós tratamos disso</p>
                </div>
                ...
                <form action="forgot-password-process" method="post" id="forgot-form" novalidate>
                    ...
                    <button type="submit" class="btn-recover" id="submit-btn">
